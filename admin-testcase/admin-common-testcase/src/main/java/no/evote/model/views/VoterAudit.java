...
public class VoterAudit implements java.io.Serializable {
	...
	public Integer getVoterNumber() {
		return this.voterNumber;
	}

	public void setVoterNumber(final Integer voterNumber) {
	...
	public Date getDateTimeSubmitted() {
		Date returnDate = null;
		if (this.dateTimeSubmitted != null) {
			returnDate = new Date(this.dateTimeSubmitted.getTime());
		}
		return returnDate;
	}
	...
	public void setDateTimeSubmitted(final Date dateTimeSubmitted) {
		if (dateTimeSubmitted != null) {
			this.dateTimeSubmitted = new Date(dateTimeSubmitted.getTime());
		} else {
	...
	public Date getRegDato() {
		Date returnDate = null;
		if (this.regDato != null) {
			returnDate = new Date(this.regDato.getTime());
		}
		return returnDate;
	}

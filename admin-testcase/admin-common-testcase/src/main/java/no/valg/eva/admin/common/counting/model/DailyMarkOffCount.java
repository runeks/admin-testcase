...
public class DailyMarkOffCount implements Serializable {
	...
	private long markOffCount;

	public DailyMarkOffCount(LocalDate date) {
		this.date = date;
	}
	
	public DailyMarkOffCount(LocalDate date, long markOffCount) {
		this.date = date;
	...
	public long getMarkOffCount() {
		return markOffCount;
	}

	public void setMarkOffCount(long markOffCount) {
		this.markOffCount = markOffCount;
	}

...
public abstract class AbstractCount implements Count, Serializable {
	...
	public boolean isEditable() {
		// TODO REJECTED SHOULD DIE!
		return isNew() || isSaved() || isRevoked() || status == CountStatus.REJECTED;
	}

	/**
	 * @return true if count status is APPROVED, false otherwise
	 */
	public boolean isApproved() {
		return status == CountStatus.APPROVED;
	}

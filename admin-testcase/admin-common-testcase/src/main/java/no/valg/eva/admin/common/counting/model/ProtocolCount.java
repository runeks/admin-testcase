...
import static no.evote.util.LangUtil.zeroIfNull;
...
public class ProtocolCount extends AbstractCount {
	...
	protected Integer specialCovers;
	...
	public ProtocolCount(String id, AreaPath areaPath, String areaName, String reportingUnitAreaName) {
		super(id, areaPath, PROTOCOL, VO, areaName, reportingUnitAreaName, MANUAL_COUNT_TRUE, null);
	}
	...
	public boolean isForeignSpecialCoversEnabled() {
		return foreignSpecialCovers != null;
	}
	...
	public void validate() {
		...
		if (specialCovers != null && specialCovers < 0) {
	...
	public boolean isHavingSpecialCovers() {
		return specialCovers != null
				|| foreignSpecialCovers != null
				|| emergencySpecialCovers != null;
	}

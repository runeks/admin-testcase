...
public final class TreeUtil {
	...
	/*	public static void printTree(final TreeNode parent, int level) {
			StringBuffer levelDec = new StringBuffer();
			for (int i = 0; i < level; i++) {
				levelDec.append("-");
			}
			System.out.println(levelDec.toString() + parent.getData().toString());

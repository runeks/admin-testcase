...
public final class ScanningLoginUtil {
	private static final String SELECT_ELECTION_EVENT = "scanningLoginSelectElectionEvent.xhtml";
	private static final String SUCCESSFUL_LOGIN = "scanningLoginSuccessful.xhtml";
